...
def main():
    ...
    copy("docs/04_オンライン導入/かんたん導入ガイド_完全図解版.pdf", u1, "01_かんたん導入ガイド_くわしい図解.pdf")
    ...
    copy("docs/04_オンライン導入/かんたん導入ガイド_完全図解版.pdf", u2, "01_かんたん導入ガイド_くわしい図解.pdf")
